  ...
  section.innerHTML = `
    <div class="max-w-7xl mx-auto container-pad">
      <div class="frame frame-glow shadow-elevated p-6 sm:p-8 bg-[radial-gradient(circle_at_100%_0%,rgba(236,72,153,0.15),transparent_70%),radial-gradient(circle_at_0%_100%,rgba(168,85,247,0.15),transparent_70%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))]">
        ...
        <!-- Live market view -->
        <article class="p-6 rounded-xl bg-white/[0.04] border border-white/10 text-center relative motion-safe:animate-fade-up bg-[radial-gradient(circle_at_10%_20%,rgba(236,72,153,0.08),transparent_70%)]" style="animation-delay:0s;">
        ...
        <!-- Real-time alerts -->
        <article class="p-6 rounded-xl bg-white/[0.04] border border-white/10 text-center relative motion-safe:animate-fade-up bg-[radial-gradient(circle_at_70%_30%,rgba(168,85,247,0.08),transparent_70%)]" style="animation-delay:0.1s;">
          <div class="w-16 aspect-square skeleton rounded mx-auto mb-4" role="img" aria-label="Icon"><span class="skeleton-label">Icon</span></div>
        ...
        <!-- Historical log -->
        <article class="p-6 rounded-xl bg-white/[0.04] border border-white/10 text-center relative motion-safe:animate-fade-up bg-[radial-gradient(circle_at_30%_80%,rgba(236,72,153,0.08),transparent_70%)]" style="animation-delay:0.2s;">
          <div class="w-16 aspect-square skeleton rounded mx-auto mb-4" role="img" aria-label="Icon"><span class="skeleton-label">Icon</span></div>
        ...
        <!-- Backtesting -->
        <article class="p-6 rounded-xl bg-white/[0.04] border border-white/10 text-center relative motion-safe:animate-fade-up bg-[radial-gradient(circle_at_80%_70%,rgba(168,85,247,0.08),transparent_70%)]" style="animation-delay:0.3s;">
          <div class="w-16 aspect-square skeleton rounded mx-auto mb-4" role="img" aria-label="Icon"><span class="skeleton-label">Icon</span></div>
