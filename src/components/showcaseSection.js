  ...
  section.innerHTML = `
    <div class="max-w-7xl mx-auto container-pad">
      ...
      <div class="grid md:grid-cols-2 gap-x-6 gap-y-8">
        <div class="frame shadow-elevated relative p-6 sm:p-8 motion-safe:animate-fade-up bg-[radial-gradient(circle_at_100%_0%,rgba(236,72,153,0.15),transparent_70%),radial-gradient(circle_at_0%_100%,rgba(168,85,247,0.15),transparent_70%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))]" style="animation-delay:0s;">
        ...
        <div class="frame shadow-elevated relative p-6 sm:p-8 motion-safe:animate-fade-up bg-[radial-gradient(circle_at_80%_20%,rgba(168,85,247,0.15),transparent_70%),radial-gradient(circle_at_0%_100%,rgba(236,72,153,0.15),transparent_70%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))]" style="animation-delay:0.1s;">
        ...
        <div class="frame shadow-elevated relative p-6 sm:p-8 motion-safe:animate-fade-up bg-[radial-gradient(circle_at_70%_80%,rgba(168,85,247,0.15),transparent_70%),radial-gradient(circle_at_0%_0%,rgba(236,72,153,0.15),transparent_70%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))]" style="animation-delay:0.3s;">
